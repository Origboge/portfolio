...
const projects = [
  {
    title: "FMYD Circular Economy Youth Empowerment", // Change this
    ...
    image: "/fmyd.png", // Put your image in 'public' folder
    liveUrl: "https://origboge.github.io/FMYD-CIRCULAR-ECO/index.html", // Vercel Link
    githubUrl: "https://origboge.github.io/FMYD-CIRCULAR-ECO/index.html", // Optional
  },
  {
    ...
    image: "/mikeflora.png",
    liveUrl: "https://origboge.github.io/MIKEFLORA/", // Vercel Link
  ...
  },
  {
    ...
    tech: ["React", "Vite", "CSS","javascript"],
    image: "/ssweb.png",
    liveUrl: "https://thesupportsystem.vercel.app/", // Leave empty if not deployed
    githubUrl: "https://thesupportsystem.vercel.app/", // GitHub Link
  },
  {
        ...
        {projects.map((project, i) => (
          ...
          >
            ...
            <div className="relative h-[60%] overflow-hidden">
              ...
              {/* Use a placeholder if user hasn't added images yet */}
              <img
                src={project.image}
                alt={project.title}
                onError={(e) => {
                  // Fallback to a generic gradient if image is missing
              ...
              <div className="absolute top-4 right-4 z-20 flex gap-2 opacity-0 group-hover:opacity-100 translate-y-[-10px] group-hover:translate-y-0 transition-all duration-300">
                {project.githubUrl && (
                  <a
                    href={project.githubUrl}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="p-3 bg-black/50 backdrop-blur-md rounded-full text-white hover:bg-white hover:text-black transition-colors border border-white/10"
                    title="View Code"
                  >
                    <Github size={20} />
                  </a>
            ...
            {/* TEXT CONTENT AREA */}
            <div className="relative z-20 p-8 flex-1 bg-[#0a0a0a] border-t border-white/5 flex flex-col justify-between">
              <div>
